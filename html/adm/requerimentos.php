...
<html lang="pt-br">
    ...
    <body>
        <aside>
            ...
            <div class="anchors">
                ...
                <a id="a-aside" href="./requerimentos.php"><i
                        class="bi bi-file-earmark-text-fill"></i>Requerimentos</a>
    ...
    <div class="buttons">
        ...
        <button onclick="location.href='nome-do-arquivo.php?ordem=tipo'">Tipo</button>
    </div>
</div>
</div>
<div class="main">
    <table>
        ...
        try {
            ...
            $sql = "SELECT id, nome, matricula, email, tipo_requerimento, observacoes, status, data_requerimento FROM requerimentos $ordem";
        ...
        <script>
            ...
            function procurar() {
                window.location = `requerimentos.html?search=${inputSearch.value}`;
            }
